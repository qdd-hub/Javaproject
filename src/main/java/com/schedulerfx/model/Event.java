...
public class Event {
	...
	public Event(Long id, String title, LocalDateTime startAt, LocalDateTime endAt, String category,int remindMinutes) {
		this.id = id;
		this.title = title;
	...
	public Event(String title, LocalDateTime startAt, LocalDateTime endAt, String category, int remindMinutes) {
